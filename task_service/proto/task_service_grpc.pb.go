...
const (
	...
	TaskService_GetTasksPage_FullMethodName = "/TaskService/GetTasksPage"
)
...
type TaskServiceClient interface {
	...
	GetTasksPage(ctx context.Context, in *GetTasksPageRequest, opts ...grpc.CallOption) (*GetTasksPageResponse, error)
}
...
func (c *taskServiceClient) GetTasksPage(ctx context.Context, in *GetTasksPageRequest, opts ...grpc.CallOption) (*GetTasksPageResponse, error) {
	out := new(GetTasksPageResponse)
	err := c.cc.Invoke(ctx, TaskService_GetTasksPage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	GetTasksPage(context.Context, *GetTasksPageRequest) (*GetTasksPageResponse, error)
...
func (UnimplementedTaskServiceServer) GetTasksPage(context.Context, *GetTasksPageRequest) (*GetTasksPageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTasksPage not implemented")
}
...
func _TaskService_GetTasksPage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTasksPageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).GetTasksPage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_GetTasksPage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).GetTasksPage(ctx, req.(*GetTasksPageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTasksPage",
			Handler:    _TaskService_GetTasksPage_Handler,
		},
	},
